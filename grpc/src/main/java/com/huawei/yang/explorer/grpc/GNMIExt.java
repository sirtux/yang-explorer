...
public final class GNMIExt {
  ...
  public enum ExtensionID
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return GNMIExt.getDescriptor().getEnumTypes().get(0);
    }
  ...
  public interface ExtensionOrBuilder extends
     ...
     */
    GNMIExt.RegisteredExtension getRegisteredExt();
    /**
     * <pre>
     * A registered extension.
     * </pre>
     ...
     * <code>.gnmi_ext.RegisteredExtension registered_ext = 1;</code>
     */
    GNMIExt.RegisteredExtensionOrBuilder getRegisteredExtOrBuilder();
     ...
     */
    GNMIExt.MasterArbitration getMasterArbitration();
    /**
     * <pre>
     * Well known extensions.
     * </pre>
     ...
     * <code>.gnmi_ext.MasterArbitration master_arbitration = 2;</code>
     */
    GNMIExt.MasterArbitrationOrBuilder getMasterArbitrationOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              GNMIExt.RegisteredExtension.Builder subBuilder = null;
              if (extCase_ == 1) {
                subBuilder = ((GNMIExt.RegisteredExtension) ext_).toBuilder();
              }
              ext_ =
                  input.readMessage(GNMIExt.RegisteredExtension.parser(), extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom((GNMIExt.RegisteredExtension) ext_);
            ...
            case 18: {
              GNMIExt.MasterArbitration.Builder subBuilder = null;
              if (extCase_ == 2) {
                subBuilder = ((GNMIExt.MasterArbitration) ext_).toBuilder();
              }
              ext_ =
                  input.readMessage(GNMIExt.MasterArbitration.parser(), extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom((GNMIExt.MasterArbitration) ext_);
                ext_ = subBuilder.buildPartial();
              }
              extCase_ = 2;
              break;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return GNMIExt.internal_static_gnmi_ext_Extension_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GNMIExt.Extension.class, GNMIExt.Extension.Builder.class);
    }
    ...
    public GNMIExt.RegisteredExtension getRegisteredExt() {
      if (extCase_ == 1) {
         return (GNMIExt.RegisteredExtension) ext_;
      }
      return GNMIExt.RegisteredExtension.getDefaultInstance();
    }
    /**
     * <pre>
     * A registered extension.
    ...
    public GNMIExt.MasterArbitration getMasterArbitration() {
      if (extCase_ == 2) {
         return (GNMIExt.MasterArbitration) ext_;
      }
      return GNMIExt.MasterArbitration.getDefaultInstance();
    }
    /**
     * <pre>
     * Well known extensions.
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (extCase_ == 1) {
        output.writeMessage(1, (GNMIExt.RegisteredExtension) ext_);
      }
      if (extCase_ == 2) {
        output.writeMessage(2, (GNMIExt.MasterArbitration) ext_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (extCase_ == 1) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, (GNMIExt.RegisteredExtension) ext_);
      }
      if (extCase_ == 2) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, (GNMIExt.MasterArbitration) ext_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof GNMIExt.Extension)) {
        return super.equals(obj);
      }
      GNMIExt.Extension other = (GNMIExt.Extension) obj;
    ...
    public static GNMIExt.Extension parseFrom(
    ...
    public static GNMIExt.Extension parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GNMIExt.Extension parseFrom(
    ...
    public static GNMIExt.Extension parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static GNMIExt.Extension parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GNMIExt.Extension parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GNMIExt.Extension prototype) {
    ...
    public static final class Builder extends
      ...
      public GNMIExt.Extension getDefaultInstanceForType() {
        return GNMIExt.Extension.getDefaultInstance();
      }

      @java.lang.Override
      public GNMIExt.Extension build() {
        GNMIExt.Extension result = buildPartial();
      ...
      @java.lang.Override
      public GNMIExt.Extension buildPartial() {
        GNMIExt.Extension result = new GNMIExt.Extension(this);
        if (extCase_ == 1) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GNMIExt.Extension) {
          return mergeFrom((GNMIExt.Extension)other);
        } else {
      ...
      public Builder mergeFrom(GNMIExt.Extension other) {
        if (other == GNMIExt.Extension.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GNMIExt.Extension parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GNMIExt.Extension) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          GNMIExt.RegisteredExtension, GNMIExt.RegisteredExtension.Builder, GNMIExt.RegisteredExtensionOrBuilder> registeredExtBuilder_;
      /**
       * <pre>
       * A registered extension.
       * </pre>
       ...
       * <code>.gnmi_ext.RegisteredExtension registered_ext = 1;</code>
       */
      public Builder setRegisteredExt(GNMIExt.RegisteredExtension value) {
        if (registeredExtBuilder_ == null) {
          if (value == null) {
      ...
      public Builder setRegisteredExt(
          GNMIExt.RegisteredExtension.Builder builderForValue) {
        if (registeredExtBuilder_ == null) {
       ...
       * <code>.gnmi_ext.RegisteredExtension registered_ext = 1;</code>
       */
      public Builder mergeRegisteredExt(GNMIExt.RegisteredExtension value) {
        if (registeredExtBuilder_ == null) {
          if (extCase_ == 1 &&
              ext_ != GNMIExt.RegisteredExtension.getDefaultInstance()) {
            ext_ = GNMIExt.RegisteredExtension.newBuilder((GNMIExt.RegisteredExtension) ext_)
       ...
       * <code>.gnmi_ext.RegisteredExtension registered_ext = 1;</code>
       */
      public GNMIExt.RegisteredExtension.Builder getRegisteredExtBuilder() {
       ...
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          GNMIExt.RegisteredExtension, GNMIExt.RegisteredExtension.Builder, GNMIExt.RegisteredExtensionOrBuilder>
        ...
        if (registeredExtBuilder_ == null) {
          ...
          registeredExtBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              GNMIExt.RegisteredExtension, GNMIExt.RegisteredExtension.Builder, GNMIExt.RegisteredExtensionOrBuilder>(
                  (GNMIExt.RegisteredExtension) ext_,
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          GNMIExt.MasterArbitration, GNMIExt.MasterArbitration.Builder, GNMIExt.MasterArbitrationOrBuilder> masterArbitrationBuilder_;
      /**
       * <pre>
       * Well known extensions.
       * </pre>
       ...
       * <code>.gnmi_ext.MasterArbitration master_arbitration = 2;</code>
       */
      public Builder setMasterArbitration(GNMIExt.MasterArbitration value) {
        if (masterArbitrationBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setMasterArbitration(
          GNMIExt.MasterArbitration.Builder builderForValue) {
        if (masterArbitrationBuilder_ == null) {
          ext_ = builderForValue.build();
          onChanged();
        } else {
       ...
       * <code>.gnmi_ext.MasterArbitration master_arbitration = 2;</code>
       */
      public Builder mergeMasterArbitration(GNMIExt.MasterArbitration value) {
        if (masterArbitrationBuilder_ == null) {
          if (extCase_ == 2 &&
              ext_ != GNMIExt.MasterArbitration.getDefaultInstance()) {
            ext_ = GNMIExt.MasterArbitration.newBuilder((GNMIExt.MasterArbitration) ext_)
                .mergeFrom(value).buildPartial();
          } else {
            ext_ = value;
          }
       ...
       * <code>.gnmi_ext.MasterArbitration master_arbitration = 2;</code>
       */
      public GNMIExt.MasterArbitration.Builder getMasterArbitrationBuilder() {
       ...
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          GNMIExt.MasterArbitration, GNMIExt.MasterArbitration.Builder, GNMIExt.MasterArbitrationOrBuilder>
        ...
        if (masterArbitrationBuilder_ == null) {
          ...
          masterArbitrationBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              GNMIExt.MasterArbitration, GNMIExt.MasterArbitration.Builder, GNMIExt.MasterArbitrationOrBuilder>(
                  (GNMIExt.MasterArbitration) ext_,
                  getParentForChildren(),
                  isClean());
          ext_ = null;
        }
    ...
    private static final GNMIExt.Extension DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GNMIExt.Extension();
    }
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return GNMIExt.internal_static_gnmi_ext_RegisteredExtension_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GNMIExt.RegisteredExtension.class, GNMIExt.RegisteredExtension.Builder.class);
    }
     ...
     * @return The id.
     */
    public GNMIExt.ExtensionID getId() {
      @SuppressWarnings("deprecation")
      GNMIExt.ExtensionID result = GNMIExt.ExtensionID.valueOf(id_);
      return result == null ? GNMIExt.ExtensionID.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
                        throws java.io.IOException {
      if (id_ != GNMIExt.ExtensionID.EID_UNSET.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof GNMIExt.RegisteredExtension)) {
        return super.equals(obj);
      }
      GNMIExt.RegisteredExtension other = (GNMIExt.RegisteredExtension) obj;
    ...
    public static GNMIExt.RegisteredExtension parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static GNMIExt.RegisteredExtension parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GNMIExt.RegisteredExtension parseFrom(
    ...
    public static GNMIExt.RegisteredExtension parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static GNMIExt.RegisteredExtension parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GNMIExt.RegisteredExtension parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GNMIExt.RegisteredExtension prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public GNMIExt.RegisteredExtension getDefaultInstanceForType() {
        return GNMIExt.RegisteredExtension.getDefaultInstance();
      }

      @java.lang.Override
      public GNMIExt.RegisteredExtension build() {
        GNMIExt.RegisteredExtension result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public GNMIExt.RegisteredExtension buildPartial() {
        GNMIExt.RegisteredExtension result = new GNMIExt.RegisteredExtension(this);
        result.id_ = id_;
        result.msg_ = msg_;
        onBuilt();
        return result;
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GNMIExt.RegisteredExtension) {
          return mergeFrom((GNMIExt.RegisteredExtension)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(GNMIExt.RegisteredExtension other) {
        if (other == GNMIExt.RegisteredExtension.getDefaultInstance()) return this;
        if (other.id_ != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GNMIExt.RegisteredExtension parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GNMIExt.RegisteredExtension) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
       ...
       * @return This builder for chaining.
       */
      public Builder setId(GNMIExt.ExtensionID value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    private static final GNMIExt.RegisteredExtension DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GNMIExt.RegisteredExtension();
    }

    public static GNMIExt.RegisteredExtension getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              GNMIExt.Role.Builder subBuilder = null;
              if (role_ != null) {
                subBuilder = role_.toBuilder();
              }
              role_ = input.readMessage(GNMIExt.Role.parser(), extensionRegistry);
              if (subBuilder != null) {
            ...
            case 18: {
              GNMIExt.Uint128.Builder subBuilder = null;
              if (electionId_ != null) {
                subBuilder = electionId_.toBuilder();
              }
              electionId_ = input.readMessage(GNMIExt.Uint128.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return GNMIExt.internal_static_gnmi_ext_MasterArbitration_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GNMIExt.MasterArbitration.class, GNMIExt.MasterArbitration.Builder.class);
    }

    public static final int ROLE_FIELD_NUMBER = 1;
    private GNMIExt.Role role_;
    /**
     * <code>.gnmi_ext.Role role = 1;</code>
     * @return Whether the role field is set.
     */
    ...
    public GNMIExt.Role getRole() {
      return role_ == null ? GNMIExt.Role.getDefaultInstance() : role_;
    }
    /**
     * <code>.gnmi_ext.Role role = 1;</code>
     */
    ...
    private GNMIExt.Uint128 electionId_;
    /**
     * <code>.gnmi_ext.Uint128 election_id = 2;</code>
     * @return Whether the electionId field is set.
     */
    ...
    public GNMIExt.Uint128 getElectionId() {
      return electionId_ == null ? GNMIExt.Uint128.getDefaultInstance() : electionId_;
    }
    /**
     * <code>.gnmi_ext.Uint128 election_id = 2;</code>
     */
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof GNMIExt.MasterArbitration)) {
        return super.equals(obj);
      }
      GNMIExt.MasterArbitration other = (GNMIExt.MasterArbitration) obj;
    ...
    public static GNMIExt.MasterArbitration parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static GNMIExt.MasterArbitration parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GNMIExt.MasterArbitration parseFrom(
    ...
    public static GNMIExt.MasterArbitration parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static GNMIExt.MasterArbitration parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GNMIExt.MasterArbitration parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GNMIExt.MasterArbitration prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
      ...
      public GNMIExt.MasterArbitration build() {
        GNMIExt.MasterArbitration result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public GNMIExt.MasterArbitration buildPartial() {
        GNMIExt.MasterArbitration result = new GNMIExt.MasterArbitration(this);
        if (roleBuilder_ == null) {
          result.role_ = role_;
        } else {
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GNMIExt.MasterArbitration) {
          return mergeFrom((GNMIExt.MasterArbitration)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(GNMIExt.MasterArbitration other) {
        if (other == GNMIExt.MasterArbitration.getDefaultInstance()) return this;
        if (other.hasRole()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GNMIExt.MasterArbitration parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GNMIExt.MasterArbitration) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      private GNMIExt.Role role_;
      private com.google.protobuf.SingleFieldBuilderV3<
          GNMIExt.Role, GNMIExt.Role.Builder, GNMIExt.RoleOrBuilder> roleBuilder_;
      /**
       * <code>.gnmi_ext.Role role = 1;</code>
       * @return Whether the role field is set.
       */
       ...
       * <code>.gnmi_ext.Role role = 1;</code>
       */
      public Builder setRole(GNMIExt.Role value) {
        if (roleBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setRole(
          GNMIExt.Role.Builder builderForValue) {
        if (roleBuilder_ == null) {
       ...
       * <code>.gnmi_ext.Role role = 1;</code>
       */
      public Builder mergeRole(GNMIExt.Role value) {
        if (roleBuilder_ == null) {
          if (role_ != null) {
            role_ =
              GNMIExt.Role.newBuilder(role_).mergeFrom(value).buildPartial();
          } else {
            role_ = value;
          }
          onChanged();
      ...
      public GNMIExt.RoleOrBuilder getRoleOrBuilder() {
        if (roleBuilder_ != null) {
          ...
          return role_ == null ?
              GNMIExt.Role.getDefaultInstance() : role_;
        }
      }
      /**
       * <code>.gnmi_ext.Role role = 1;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          GNMIExt.Role, GNMIExt.Role.Builder, GNMIExt.RoleOrBuilder>
          getRoleFieldBuilder() {
        if (roleBuilder_ == null) {
      ...
      private GNMIExt.Uint128 electionId_;
      private com.google.protobuf.SingleFieldBuilderV3<
          GNMIExt.Uint128, GNMIExt.Uint128.Builder, GNMIExt.Uint128OrBuilder> electionIdBuilder_;
      /**
       * <code>.gnmi_ext.Uint128 election_id = 2;</code>
       * @return Whether the electionId field is set.
       */
       ...
       * <code>.gnmi_ext.Uint128 election_id = 2;</code>
       */
      public Builder setElectionId(GNMIExt.Uint128 value) {
        if (electionIdBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setElectionId(
          GNMIExt.Uint128.Builder builderForValue) {
        if (electionIdBuilder_ == null) {
       ...
       * <code>.gnmi_ext.Uint128 election_id = 2;</code>
       */
      public Builder mergeElectionId(GNMIExt.Uint128 value) {
        if (electionIdBuilder_ == null) {
          if (electionId_ != null) {
            electionId_ =
              GNMIExt.Uint128.newBuilder(electionId_).mergeFrom(value).buildPartial();
          } else {
            electionId_ = value;
          }
          onChanged();
      ...
      public GNMIExt.Uint128OrBuilder getElectionIdOrBuilder() {
        if (electionIdBuilder_ != null) {
          ...
          return electionId_ == null ?
              GNMIExt.Uint128.getDefaultInstance() : electionId_;
        }
      }
      /**
       * <code>.gnmi_ext.Uint128 election_id = 2;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          GNMIExt.Uint128, GNMIExt.Uint128.Builder, GNMIExt.Uint128OrBuilder>
    ...
    private static final GNMIExt.MasterArbitration DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GNMIExt.MasterArbitration();
    }

    public static GNMIExt.MasterArbitration getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return GNMIExt.internal_static_gnmi_ext_Uint128_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GNMIExt.Uint128.class, GNMIExt.Uint128.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof GNMIExt.Uint128)) {
        return super.equals(obj);
      }
      GNMIExt.Uint128 other = (GNMIExt.Uint128) obj;
    ...
    public static GNMIExt.Uint128 parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static GNMIExt.Uint128 parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GNMIExt.Uint128 parseFrom(
    ...
    public static GNMIExt.Uint128 parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static GNMIExt.Uint128 parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GNMIExt.Uint128 parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GNMIExt.Uint128 prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public GNMIExt.Uint128 getDefaultInstanceForType() {
        return GNMIExt.Uint128.getDefaultInstance();
      }

      @java.lang.Override
      public GNMIExt.Uint128 build() {
        GNMIExt.Uint128 result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public GNMIExt.Uint128 buildPartial() {
        GNMIExt.Uint128 result = new GNMIExt.Uint128(this);
        result.high_ = high_;
        result.low_ = low_;
        onBuilt();
        return result;
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GNMIExt.Uint128) {
          return mergeFrom((GNMIExt.Uint128)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(GNMIExt.Uint128 other) {
        if (other == GNMIExt.Uint128.getDefaultInstance()) return this;
        if (other.getHigh() != 0L) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GNMIExt.Uint128 parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GNMIExt.Uint128) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
    ...
    private static final GNMIExt.Uint128 DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GNMIExt.Uint128();
    }

    public static GNMIExt.Uint128 getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return GNMIExt.internal_static_gnmi_ext_Role_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GNMIExt.Role.class, GNMIExt.Role.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof GNMIExt.Role)) {
        return super.equals(obj);
      }
      GNMIExt.Role other = (GNMIExt.Role) obj;
    ...
    public static GNMIExt.Role parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static GNMIExt.Role parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GNMIExt.Role parseFrom(
    ...
    public static GNMIExt.Role parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static GNMIExt.Role parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GNMIExt.Role parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GNMIExt.Role prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public GNMIExt.Role getDefaultInstanceForType() {
        return GNMIExt.Role.getDefaultInstance();
      }

      @java.lang.Override
      public GNMIExt.Role build() {
        GNMIExt.Role result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public GNMIExt.Role buildPartial() {
        GNMIExt.Role result = new GNMIExt.Role(this);
        result.id_ = id_;
        onBuilt();
        return result;
      }
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GNMIExt.Role) {
          return mergeFrom((GNMIExt.Role)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(GNMIExt.Role other) {
        if (other == GNMIExt.Role.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GNMIExt.Role parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GNMIExt.Role) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final GNMIExt.Role DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GNMIExt.Role();
    }

    public static GNMIExt.Role getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
