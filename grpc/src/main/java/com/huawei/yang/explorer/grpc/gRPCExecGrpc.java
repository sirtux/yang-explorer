...
public final class gRPCExecGrpc {
  ...
  public static final io.grpc.MethodDescriptor<XRGRPC.ShowCmdArgs,
      XRGRPC.ShowCmdTextReply> METHOD_SHOW_CMD_TEXT_OUTPUT =
      io.grpc.MethodDescriptor.<XRGRPC.ShowCmdArgs, XRGRPC.ShowCmdTextReply>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
          .setFullMethodName(generateFullMethodName(
              "IOSXRExtensibleManagabilityService.gRPCExec", "ShowCmdTextOutput"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              XRGRPC.ShowCmdArgs.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              XRGRPC.ShowCmdTextReply.getDefaultInstance()))
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<XRGRPC.ShowCmdArgs,
      XRGRPC.ShowCmdJSONReply> METHOD_SHOW_CMD_JSONOUTPUT =
      io.grpc.MethodDescriptor.<XRGRPC.ShowCmdArgs, XRGRPC.ShowCmdJSONReply>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
          .setFullMethodName(generateFullMethodName(
          ...
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              XRGRPC.ShowCmdArgs.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              XRGRPC.ShowCmdJSONReply.getDefaultInstance()))
          .build();
  ...
  public static abstract class gRPCExecImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void showCmdTextOutput(XRGRPC.ShowCmdArgs request,
                                  io.grpc.stub.StreamObserver<XRGRPC.ShowCmdTextReply> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_SHOW_CMD_TEXT_OUTPUT, responseObserver);
    }

    /**
     */
    public void showCmdJSONOutput(XRGRPC.ShowCmdArgs request,
                                  io.grpc.stub.StreamObserver<XRGRPC.ShowCmdJSONReply> responseObserver) {
  ...
  public static final class gRPCExecBlockingStub extends io.grpc.stub.AbstractStub<gRPCExecBlockingStub> {
     ...
     * </pre>
     */
    public java.util.Iterator<XRGRPC.ShowCmdTextReply> showCmdTextOutput(
        XRGRPC.ShowCmdArgs request) {
    ...
    /**
     */
    public java.util.Iterator<XRGRPC.ShowCmdJSONReply> showCmdJSONOutput(
        XRGRPC.ShowCmdArgs request) {
      return blockingServerStreamingCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SHOW_CMD_TEXT_OUTPUT:
          serviceImpl.showCmdTextOutput((XRGRPC.ShowCmdArgs) request,
              (io.grpc.stub.StreamObserver<XRGRPC.ShowCmdTextReply>) responseObserver);
          break;
        case METHODID_SHOW_CMD_JSONOUTPUT:
          serviceImpl.showCmdJSONOutput((XRGRPC.ShowCmdArgs) request,
              (io.grpc.stub.StreamObserver<XRGRPC.ShowCmdJSONReply>) responseObserver);
          break;
        default:
